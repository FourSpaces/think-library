 ...
 * 管理员模型
 */
class ManagerinfoModel extends Model{

/* 用户模型自动验证 */
	protected $_validate = array(
		/* 验证用户名 */
		array('loginname', '1,20', -1, self::EXISTS_VALIDATE, 'length'), //用户名长度不合法
		array('loginname', '', -3, self::EXISTS_VALIDATE, 'unique'), //用户名被占用

		/* 验证密码 */
		array('loginpwd', '6,30', -4, self::EXISTS_VALIDATE, 'length'), //密码长度不合法
