...
<div class="container-fluid">
  ...
  <div class="well">
     <form class="demoform" action="<?php echo U('');?>">
      ...
      <input name='parentid' type="hidden" value="<?php echo ((isset($info["parentid"]) && ($info["parentid"] !== ""))?($info["parentid"]):''); ?>">
      <ul style="list-style-type: none;">
        <li>
          <label>分类名称：</label>
          <input id="input_typename" name="name" type="text" value="<?php echo ((isset($info["name"]) && ($info["name"] !== ""))?($info["name"]):''); ?>" class="input-xlarge" datatype="s2-12" errormsg="分类名称至少2个字符,最多12个字符！" sucmsg="&nbsp;">
