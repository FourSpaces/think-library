...
<div class="btn-toolbar">
   <a href="<?php echo U('Admin/Usermanage/AdministratorAdd');?>" class="btn btn-primary"><i class="icon-plus"></i>添加管理员</a>
    <!--
    ...
    <table class="table">
      ...
      <tbody>
          <?php if(!empty($list)): if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($k % 2 );++$k;?><tr>
                ...
                <td>
                  <a href="<?php echo U('Admin/Usermanage/AdministratorEdit',array('id'=>$order['userid']));?>" title="编辑"><i class="icon-pencil"></i></a>&nbsp;&nbsp;&nbsp;
                  <!-- href="#myModal"  -->
  ...
  <script>
    function deletestyle(value){
          ...
          $("#modal_delete").on("click",function(){
            //在点击按钮后延迟动作
            setTimeout(function(){
              $.post("<?php echo U('Admin/Usermanage/deleteAdministrator');?>",{ id:value,},
