...
<body>
  ...
  <ul class="breadcrumb">
    ...
    <li class="active"><?php if(($titleTab) == "1"): ?>添加<?php else: ?>编辑<?php endif; ?>分类</li>
  </ul>
  ...
  <div class="well">
     <form class="demoform" action="<?php echo U('');?>">
      ...
      <ul style="list-style-type: none;">
        <li>
          <label>分类名称：</label>
          <input id="input_typename" name="pressname" type="text" value="<?php echo ((isset($info["typename"]) && ($info["typename"] !== ""))?($info["typename"]):''); ?>" class="input-xlarge" datatype="*2-12" errormsg="分类名称至少2个字符,最多12个字符！" sucmsg="&nbsp;">
