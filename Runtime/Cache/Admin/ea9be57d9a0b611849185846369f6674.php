...
<div class="container-fluid">
  <div class="row-fluid">            
    ...
    <div class="btn-toolbar">
        <a href="<?php echo U('Admin/Article/AddArticle');?>" class="btn btn-primary"><i class="icon-plus"></i>添加文章</a>
        <!--
        ...
        <table class="table">
          ...
          <tbody>
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($order["summary"]); ?></td>
                <td><?php echo ($sort[$order['type']]); ?></td>               
                <td><?php echo (date('Y-m-d H:i',$order["createtime"])); ?></td>
                <td>
                  <a href="<?php echo U('Admin/Article/EditArticle',array('id'=>$order['id']));?>" title="编辑"><i class="icon-pencil"></i></a>&nbsp;&nbsp;&nbsp;
                  <!-- href="#myModal"  -->
    ...
    <div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            <p class="error-text"><i class="icon-warning-sign modal-icon"></i>你确定要删除此文章</p>
        </div>
  ...
  <script>
    function deletestyle(value){
          ...
          $("#modal_delete").on("click",function(){
            //在点击按钮后延迟动作
            setTimeout(function(){
              $.post("<?php echo U('Admin/Article/DeletArticle');?>",{ id:value,},
