...
<body>
			...
			<div class="content-left">
				...
				<div class="content-list-blue">
					...
					<div class="service-msg listitem" style="display: none;">
						<img src="<?php echo C('DOMAIN');?>./Application/Home/View/workshop/images/service.jpg">
						<p>请点击<a href="http://202.199.155.201:808/chuandi/index.asp" class="details">[详细]</a>查看具体内容</p>
					</div>
					<!-- 信息咨询简介 -->
					<div class="service-msg listitem" style="display: none;">
						<img src="<?php echo C('DOMAIN');?>./Application/Home/View/workshop/images/service.jpg">
	...
	<div class="page" id="page-library">
		<!-- 页面标题 -->
		<div class="title-wrapper">
			<h1 class="title"><a href="charmlibrary.html" target="_blank">魅力图书馆</a></h1>
		</div>
		<!-- 内容区容器 -->
		<div class="content-wrapper">
			<!-- 左侧发刊词 -->
	...
	<div class="page" id="page-thinker" style="display:none;">
		<!-- 页面标题 -->
		<div class="title-wrapper">
			<h1 class="title"><a href="thinker.html" target="_blank">思想者</a></h1>
		</div>
		<!-- 导航按钮 -->
