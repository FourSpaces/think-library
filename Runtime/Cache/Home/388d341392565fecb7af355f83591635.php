...
<!-- title -->
    ...
    <?php else: ?>
     ...
     <dd>
        ...
        <div class="content-right">         
            <h2>
                <a id="login_folds" class="noaction" href="<?php echo U('PrivateLibrary/LendBook');?>">借书</a>
                <a id="register_folds"  href="<?php echo U('PrivateLibrary/AlsoBook');?>">还书</a>
            </h2>
                  ...
                  <table class="table">
                      ...
                      <tbody id ="book-tbdoy">
                        <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($i % 2 );++$i;?><tr>
                              ...
                              <td>
                                <a href="" onclick="lendpost(this)" title="还书" data-value="<?php echo ($order["id"]); ?>" data-bookid="<?php echo ($order["bookid"]); ?>" class="btn btn-success btn-sm">还书</a>
                              </td>
    ...
    <script type="text/javascript">
        function lendpost(event){
          ...
          $.post("<?php echo U('PrivateLibrary/AlsoBook');?>",
            {
              alsoid:alsoid,
              bookid:bookid
            },
