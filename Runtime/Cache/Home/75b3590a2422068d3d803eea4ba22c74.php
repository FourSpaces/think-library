...
<!-- title -->
    <h3><a href="index.html">首页</a>&nbsp;&gt;&nbsp;<a href="javascript:void(0)">概况</a></h3>
    ...
    <div class="content-container">
	 ...
	 <!-- 左侧侧边栏 -->
        <dl class="content-left">
            <dt>概况</dt>
            <dd><a href="<?php echo U('Introduce/index',array('id'=>18));?>" class=<?php if(($sidebar) == "bgjs"): ?>'action'<?php else: ?>''<?php endif; ?>>本馆建设</a></dd>
            <dd><a href="<?php echo U('Introduce/index',array('id'=>19));?>" class=<?php if(($sidebar) == "fbts"): ?>'action'<?php else: ?>''<?php endif; ?>>分布图示</a></dd>
            <dd><a href="<?php echo U('Introduce/index',array('id'=>20));?>" class=<?php if(($sidebar) == "gsfm"): ?>'action'<?php else: ?>''<?php endif; ?>>馆舍风貌</a></dd>
            <dd><a href="<?php echo U('Introduce/index',array('id'=>23));?>" class=<?php if(($sidebar) == "bmsz"): ?>'action'<?php else: ?>''<?php endif; ?>>部门设置</a></dd>
            <dd><a href="<?php echo U('Introduce/index',array('id'=>9,'type'=>1));?>" class=<?php if(($sidebar) == "gzdt"): ?>'action'<?php else: ?>''<?php endif; ?>>工作动态</a></dd>
            <dd><a href="<?php echo U('Introduce/index',array('id'=>11,'type'=>1));?>" class=<?php if(($sidebar) == "yjya"): ?>'action'<?php else: ?>''<?php endif; ?>>应急预案</a></dd>
        </dl>
        <!-- 右侧内容区 -->
        <div class="content-right">         
            <h2><a href="javascript:void(0)">
                <?php switch($sidebar): case "bgjs": ?>本馆建设<?php break;?>
                    <?php case "fbts": ?>分布图示<?php break;?>
                    <?php case "gsfm": ?>馆舍风貌<?php break;?>
                    <?php case "bmsz": ?>部门设置<?php break;?>
                    <?php case "gzdt": ?>工作动态<?php break;?>
                    <?php case "yjya": ?>应急预案<?php break;?>
                    <?php default: ?>其他<?php endswitch;?>
                </a><span class="fold">折叠</span></h2>
                <?php if(($sidebarTab) == "1"): ?><ul class="content">
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Introduce/ShowArticle',array('id'=>$vo['id']));?>"><?php echo ($vo["title"]); ?></a><span><?php echo (date('m-d',$vo["createtime"])); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                    <?php else: ?>
                    <div class="content">
                        <div class="conTxt">
