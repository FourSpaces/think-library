    ...
    <div class="content-container">
	 ...
	 <!-- 左侧侧边栏 -->
        <dl class="content-left">
            ...
            <dd style="display:none;"><a href="<?php echo U('Server/ShowArticle',array('id'=>13));?>" >学位论文提交</a></dd>
            ...
            <dd><a href="<?php echo U('Server/ShowArticle',array('id'=>15));?>">常见问题</a></dd>
            <dd><a href="<?php echo U('Server/ShowArticle',array('id'=>12));?>">关于自习室</a></dd>
